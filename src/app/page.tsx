    ...
    <div className="container">
      ...
      <div className="hero" id="home">
        <h1 className="hero-building-ki">
          <span className="hero-building">Building</span>{" "}
          <span className="hero-ki">Ki</span>
        </h1>
      </div>
      ...
      {/* <footer>
        <span className="footer-copy">© 2026 raybuilds021</span>
        <span className="footer-email"><a href="mailto:build.ray.build@gmail.com">build.ray.build@gmail.com</a></span>
      </footer> */}
    </div>
  );
}
